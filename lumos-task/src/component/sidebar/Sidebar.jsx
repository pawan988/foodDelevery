  ...
  return (
    <div>
      <button
        ...
        type="button"
        class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-black-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
        <HiMiniBars3BottomLeft style={{ width: "30px", height: "30px" }} />
      </button>
