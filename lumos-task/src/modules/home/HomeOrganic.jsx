...
const HomeOrganic = () => {
  return (
    <div className="homeOrga-main">
      <div className="homeOrg-wrapper lg:flex lg:flex-row flex flex-col">
        ...
        <div className="homeOrg-left flex flex-col justify-center items-center">
          ...
          <div
            className="homeOrgText 
          font-poppins font-normal text-sm leading-6 text-k-assent mb:2 xl:mb-14"
          >
            <h1>
          ...
          <div className="flex justify-start items-start w-46">
